      ...
      <div>
        <div className="bg-black overflow-hidden whitespace-nowrap transform rotate-3 origin-left">
          <div className="inline-block min-w-full animate-marquee text-white text-2xl px-4">
            BUY ONE GET ONE AT ₹999 • BUY ONE GET ONE AT ₹999 • BUY ONE GET ONE
            AT ₹999 • BUY ONE GET ONE AT ₹999 • BUY ONE GET ONE AT ₹999 • BUY
            ONE GET ONE AT ₹999 • BUY ONE GET ONE AT ₹999 • BUY ONE GET ONE AT
            ₹999 • BUY ONE GET ONE AT ₹999 • BUY ONE GET ONE AT ₹999 •
          </div>
        </div>
        <div className="px-4">
          <Hero filter="999" />
