      ...
      <div className="container mx-auto px-4 pt-2 flex-1">
        ...
        <section className="my-16 md:my-24">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-light mb-6 text-gray-900">Footex Journey</h2>
            <div className="space-y-4 text-gray-600">
              <p className="text-base md:text-lg leading-relaxed">
                From the lush landscapes of Kerala to your doorstep, we bring you quality footwear 
              ...
              >
                ...
                <div className="relative aspect-[9/16] bg-gray-100 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105 border border-gray-200">
                  <video
                    ...
                    onPause={() => setActiveVideo(activeVideo === index ? null : activeVideo)}
                  >
                  ...
                  {/* Play/Pause Overlay */}
                  <div className={`absolute inset-0 flex items-center justify-center bg-black transition-all duration-300 ${
                    activeVideo === index ? 'bg-opacity-0' : 'bg-opacity-20'
                  } group-hover:bg-opacity-10`}>
                    <div className={`flex items-center justify-center w-16 h-16 bg-white rounded-full shadow-2xl transition-all duration-300 ${
                      activeVideo === index ? 'opacity-0 scale-0' : 'opacity-100 scale-100'
        ...
        <section className="my-16 md:my-24">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-light text-gray-900 mb-4">Loved by Thousands</h2>
        ...
        <section className="my-16 md:my-24 text-center">
          <div className="max-w-md mx-auto space-y-6">
            ...
            <p className="text-gray-600">
              Experience the Footex difference - quality, comfort, and style in every step.
            </p>
